...
public class FactionPickerHud : MonoBehaviour
{
    ...
    private void Confirm(FactionId choice)
    {
        ...
        // if the region picker is ALSO enabled, show it next rather than
        // duplicating BeginMatch's own call; otherwise start the match
        // directly, exactly as Start() would have without either picker.
