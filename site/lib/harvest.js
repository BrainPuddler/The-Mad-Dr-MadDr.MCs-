 ...
 */
import { bodyAxis, partAxis, } from "./genome.js";
import { BODY_PLANS, express, isVestigial } from "./catalog.js";
const TOOLLESS = { blood: 0.4, bone: 0.4, brain: 0.2, drainsLiving: false };
...
const FLYING_PLANS = ["winged", "floater"];
export function harvestProfile(g) {
...
export function groundSpeedFactor(fill) {
...
export function flightSpeedFactor(fill) {
    const f = fill < 0 ? 0 : fill > 1 ? 1 : fill;
