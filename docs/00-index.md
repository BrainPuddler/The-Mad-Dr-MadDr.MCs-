...
| [23-rts-master-build-plan.md](23-rts-master-build-plan.md) | **Execution plan** for the full-RTS expansion: three-faction combat + hybrid 4th category, themed bases & building rosters, Blood/Fuel/Ichor economy, RPG levels/gear/Fusion, flocking control, Lumen-clock time-of-day bonuses, roaming power-ups, NY/Paris/Montreal 1950s regions, Mafia-school graphics ladder, deterministic-lockstep 4v4 netcode | Execution plan |
